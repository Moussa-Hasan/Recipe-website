...
<body>
    ...
    <div style="text-align: center;">
        <h1><a href="#" style="color: black; text-decoration: none; font-family: 'Playfair Display', serif;">Picked For You</a></h1>
    </div>
    ...
    <ul class="cards" id="recipes">
        ...
        // Query to fetch data from the database (preference)
        $sql_user = "SELECT preferences FROM login_users WHERE user_id = '$id'";
        $result_user = mysqli_query($con, $sql_user);
        $row_user = mysqli_fetch_assoc($result_user);

        $preference = $row_user['preferences'];

        // Query to fetch data from the database
        $sql = "SELECT * FROM recipes WHERE cuisine = '$preference' AND status='approved'";
